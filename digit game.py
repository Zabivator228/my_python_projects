...
# цель игры - отгадать сгенерированное программой случайное число за наименьшее количество попыток
# при написании были использованы условные операторы, функции, бесконечные циклы с параметрами (continue, break)
